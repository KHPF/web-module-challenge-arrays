...
var nFlavor= originalFlavors.unshift('Rainbow Sherbert')

function addFlavor(originalFlavors,nFlavor){
originalFlavors === nFlavor;
...
function getFlavorByIndex(originalFlavors,indexPos){
    let index = originalFlavors[indexPos]
    return index;
}
...
function removeFlavorByName(originalFlavors,flavorNames){
    for(let i=0;i<originalFlavors.length;i++){
        if(originalFlavors[i]=== flavorNames){
...
let copiedArray =[...originalFlavors]
...
copy(copiedArray,originalFlavors);
...
let newArray = []
function filterByWord(originalFlavors,nameOfFlavor){
    for (let i=0;i<originalFlavors.length;i++){
        if(originalFlavors[i].includes(nameOfFlavor)){
